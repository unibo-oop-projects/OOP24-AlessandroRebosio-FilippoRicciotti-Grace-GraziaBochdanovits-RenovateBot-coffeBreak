...
class TestScoreManager {
    ...
    void testLeaderboardOrderingAndHighestScore() {
        ...
        Entry entry3 = new ScoreEntry("Player3", TEST_SCORE_MEDIUM);
        ...
        List<Entry> leaderboard = this.scoreManager.getLeaderBoard();
    ...
    void testFullWorkflow() {
        ...
        int expectedTotal = TEST_SCORE_SMALL + TEST_BONUS_VALUE + TEST_SCORE_MEDIUM + (TEST_BONUS_VALUE / 2);
        this.scoreManager.endGame(TEST_PLAYER);

        Entry expectedEntry = new ScoreEntry(TEST_PLAYER, expectedTotal);
