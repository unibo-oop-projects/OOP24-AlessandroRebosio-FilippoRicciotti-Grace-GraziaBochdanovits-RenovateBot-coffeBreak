...
public class GameOverPanel implements GameStatePanel {
     ...
     * @param controller controller for retrieving the gamestate and the Leaderboard
     */
    public GameOverPanel(final ResourceLoader resources, final Controller controller) {
