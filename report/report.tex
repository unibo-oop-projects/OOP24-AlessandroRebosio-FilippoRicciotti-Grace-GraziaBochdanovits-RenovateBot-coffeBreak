...
\begin{description}
    \item[\textbf{Problema}]
    Nei diversi \texttt{ViewState} del gioco (come \texttt{MenuViewState}, \texttt{InGameViewState}, \texttt{PauseViewState}, \texttt{GameOverViewState}), la gestione dei comandi dell’utente presentava duplicazioni, specialmente per le azioni comuni come il ritorno al menu o l’uscita dal gioco. Questo aumentava il rischio di incongruenze e complicava l’aggiunta di nuove funzionalità condivise tra gli stati.
