...
\begin{itemize}
	...
	\item \textbf{Menù principale:}
	      il sistema deve offrire un menù iniziale con opzioni per avviare una nuova partita oppure per uscire dal gioco.
\end{itemize}
...
\begin{itemize}
	...
	\item \texttt{TestInGameModelState:} verifica la logica di gioco attiva, inclusi aggiornamenti delle entità, gestione del motore fisico, lancio dei barili dall'antagonista, movimento del giocatore e transizioni agli stati di pausa e game over.
...
\begin{sloppypar}
	\raggedright
	\url{https://github.com/alessandrorebosio/OOP24-coffeBreak/blob/5e3a4e1fe9797d4520bcf10ff37266e84f750bc4/src/main/java/it/unibo/coffebreak/impl/model/states/ingame/InGameModelState.java#L62-L66}
\end{sloppypar}
