...
In questo progetto abbiamo cercato di creare dei test per ogni classe utilizzando JUnit 5. Facendo in modo che i test coprissero le principali funzionalità del software, abbiamo garantito che le componenti fondamentali fossero verificate automaticamente. Di seguito vengono riportati alcuni esempi di test implementati.
